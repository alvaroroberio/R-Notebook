...
for (i in numeros) { if (numeros[i] %% 2==0)
  print(numeros[i])}

# Ímpares 

for (i in numeros) { if (numeros[i] %% 2==1)
  print(numeros[i])}

```

# 4. women é um dataframe existente no R. Imprima as 10 úlimas linhas. 

```{r}

# Carregando a base de dados women 

data(women)

# Imprimindo as 10 últimas linhas 
...
data(iris)
novoiris= iris[50:100, c(2:3)]

plot(novoiris$Sepal.Width, novoiris$Sepal.Length)
